...
(function () {
  ...
  function setupDB() {
    db.transaction(function(tx) {
      tx.executeSql("CREATE TABLE IF NOT EXISTS shoeSize(id INTEGER PRIMARY KEY UNIQUE, eu FLOAT, usMen FLOAT, usWomen FLOAT, uk FLOAT, cm FLOAT, usKid TEXT);");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (1, 32.5, 1, 2.5, 0.5, 20, '1Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (2, 33, 1.5, 3, 1, 20.5, '1.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (3, 33.5, 2, 3.5, 1.5, 21, '2Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (4, 34, 2.5, 4, 2, 21.5, '2.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (5, 35, 3, 4.5, 2.5, 22, '3Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (6, 35.5, 3.5, 5, 3, 22.5, '3.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (7, 36, 4, 5.5, 3.5, 23, '4Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (8, 36.5, 4.5, 6, 4, 23.5, '4.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (9, 37.5, 5, 6.5, 4.5, 23.5, '5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (10, 38, 5.5, 7, 5, 24, '5.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (11, 38.5, 6, 7.5, 5.5, 24, '6Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (12, 39, 6.5, 8, 6, 24.5, '6.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (13, 40, 7, 8.5, 6, 25, '7Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (14, 40.5, 7.5, 9, 6.5, 25.5, '7.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (15, 41, 8, 9.5, 7, 26, '8Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (16, 42, 8.5, 10, 7.5, 26.5, '8.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (17, 42.5, 9, 10.5, 8, 27, '9Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (18, 43, 9.5, 11, 8.5, 27.5, '9.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (19, 44, 10, 11.5, 9, 28, '10Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (20, 44.5, 10.5, 12, 9.5, 28.5, '10.5Y');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (21, 45, 11, 12.5, 10, 29, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (22, 45.5, 11.5, 13, 10.5, 29.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (23, 46, 12, 13.5, 11, 30, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (24, 47, 12.5, 14, 11.5, 30.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (25, 47.5, 13, 14.5, 12, 31, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (26, 48, 13.5, 15, 12.5, 31.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (27, 48.5, 14, 15.5, 13, 32, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (28, 49, 14.5, 16, 13.5, 32.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (29, 49.5, 15, 16.5, 14, 33, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (30, 50, 15.5, 17, 14.5, 33.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (31, 50.5, 16, 17.5, 15, 34, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (32, 51, 16.5, 18, 15.5, 34.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (33, 51.5, 17, 18.5, 16, 35, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (34, 52, 17.5, 19, 16.5, 35.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (35, 52.5, 18, 19.5, 17, 36, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (36, 53, 18.5, 20, 17.5, 36.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (37, 53.5, 19, 20.5, 18, 37, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (38, 54, 19.5, 21, 18.5, 37.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (39, 54.5, 20, 21.5, 19, 38, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (40, 55, 20.5, 22, 19.5, 38.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (41, 55.5, 21, 22.5, 20, 39, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (42, 56, 21.5, 23, 20.5, 39.5, '');");
      tx.executeSql("INSERT INTO shoeSize (id, eu, usMen, usWomen, uk, cm, usKid) VALUES (43, 56.5, 22, 23.5, 21, 40, '');");
    });
  }
